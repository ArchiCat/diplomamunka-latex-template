...
% csak extrém esetben válassza el a szavakat
\hyphenpenalty 10000
% és ne is nagyon kiabáljon alatta, hogy overfull/undefull hbox
\hbadness 10000 

% szavak, amiket nem szabad elválasztani és szavak, amiket adott helyen kell elválasztani
\hyphenation{MaxWhere pác-só}
...
\begin{document}
	...
	A \ref{fig:ujlogo} az új logónk látható, a \ref{fig:ujlogo}\subref{fig:oe} ábrán az Óbudai Egyetemé,a \ref{fig:nik} ábrán az Neumann karé,
	
	\begin{figure}[H]
        \centering
        \subfloat[OE]{
            \label{fig:oe}
            \includegraphics[height=4cm]{img/OE.png}
        }
        \qquad % a két kép elválasztásának legegyszerűbb módja
        \subfloat[NIK]{
            \label{fig:nik}
            \includegraphics[height=4cm]{img/NIK.png}
        }
	...
	\subsection{Pszeudokódok}
	    ...
	    % praaméterek: az algoritmus megnevezése, a hivatkozása és a szélesége a lap arányaiban
